...
//if (isset($_POST['edit'])) {
 ...
 <div class="col-md-4">
    ...
    <input type="text" class="form-control" id="validationCustom01" value="<?php echo $row['id'] ?>"  name="id" required>
  ...
  <div class="col-md-4">
    ...
    <input type="text" class="form-control" id="validationCustom01" value="<?php echo $row['firstname'] ?>"  name="firstname" required>
   <!--  <div class="valid-feedback">
      Looks good!
    </div> -->
  </div>
  ...
  <div class="col-md-4">
    ...
    <input type="text" class="form-control" id="validationCustom02" value="<?php echo $row['middlename'] ?>" name="middlename" required>
    <!-- <div class="valid-feedback">
      Looks good!
    </div> -->
  </div>
  ...
  <div class="col-md-4">
    ...
    <input type="text" class="form-control" id="validationCustom02" value="<?php echo $row['mothername'] ?>" name="mothername" required>
    <!-- <div class="valid-feedback">
      Looks good!
    </div> -->
  </div>
  ...
  <div class="col-md-4">
    ...
    <input type="text" class="form-control" id="validationCustom02" value="<?php echo $row['birthdate'] ?>" name="birthdate"required>
    <!-- <div class="valid-feedback">
      Looks good!
    </div> -->
  </div>
  ...
  <div class="col-md-4">
    ...
    <input type="text" class="form-control" id="validationCustom02" value="<?php echo $row['mobnum'] ?>" name="mobnum" required>
    <!-- <div class="valid-feedback">
      Looks good!
    </div> -->
  </div>
...
<div class="col-md-4">
  ...
  <div class="form-check">
    ...
    <label class="form-check-label" for="flexRadioCheckedDisabled" gender>
      female
    </label>
  </div>
</div>
  ...
  <div class="col-md-4">
    ...
    <input type="text" class="form-control" id="validationCustom02" value="<?php echo $row['email'] ?>" name="email" >
    <!-- <div class="valid-feedback">
      Looks good!
    </div> -->
  </div>
  ...
  <div class="col-6">
    <input class="btn btn-primary" type="submit" name="insert" value="Update">
...
$city=$_POST['city'];
 ...
 mysqli_query($con,"update address set  firstname='$firstname', middlename='$middlename', lastname='$lastname', mothername='$mothername', birthdate='$birthdate', mobnum='$mobnum', bloodgroup='$bloodgroup', gender='$gender', email='$email', city='$city' where id='$id'");

//header("Location:donersdetail.php");
