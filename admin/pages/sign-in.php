              ...
              <div class="card-body">
               ...
               <!--  <form role="form" class="text-start">
                  ...
                  <div class="text-center">
                    <button type="button" class="btn bg-gradient-primary w-100 my-4 mb-2" name="sign-in">Sign in</button>
                  </div>
                  <p class="mt-4 text-sm text-center">
                    ...
                    <form method="post" action="ind.php">
                       <div class="mb-3">
                          ...
                          <input type="email" class="form-control"  name="user_email" placeholder="inter your email">
                        </div>


                        <div class="mb-3">
                          <label for="exampleInputPassword1" class="form-label">Password</label>
                          <input type="password" class="form-control"  name="user_pass" placeholder="inter your password">
                        </div>
                   ...
                   <!--    <div class="col-md-6">
                        ...
                        <div class="mb-3 form-check">
                         ...
                         <!-- <a href="#" name="sign" class="btn btn-primary">sign-in</a> -->
                         <input type="submit" class="btn btn-primary" name="sign" id="sign">  
                        <!-- <button type="submit" class="btn btn-primary" name="sign">Submit</button> -->
                         <p class="mt-4 text-sm text-center">
                              Don't have an account?
                              <a href="../pages/sign-up.php" class="text-primary text-gradient font-weight-bold" name="sign">Sign up</a>
                          </p>
                    </form>
