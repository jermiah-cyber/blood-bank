...
<form class="row g-3 needs-validation" method="post" novalidate>
  ...
  <div class="col-md-4">
    ...
    <input type="text" class="form-control" id="validationCustom02" value="" placeholder="inter mobile Nomber" name="mobnum" required>
    <!-- <div class="valid-feedback">
      Looks good!
    </div> -->
  </div>
...
if (isset($_POST['insert'])) {
  ...
  mysqli_query($con,"insert into address(firstname,middlename,lastname,mothername,birthdate,mobnum,bloodgroup,gender,email,city) values('$firstname','$middlename','$lastname','$mothername','$birthdate','$mobnum','$bloodgroup','$gender','$email','$city')");
