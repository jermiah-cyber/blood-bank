...
if (isset($_POST['serch'])) {
  ...
  $check=mysqli_query($con,"select * from employee where Efirstname='$Efirstname'");
...
//  $Epass=md5($Epass);
  ...
  mysqli_query($con,"update employee set Efirstname='$Efirstname', Emiddlename='$Emiddlename', Elastname='$Elastname', Emothername='$Emothername', Ebirthdate='$Ebirthdate', Emobnum='$Emobnum', Eposition='$Eposition', Eemail='$Eemail',Epass='$Epass', Ecity='$Ecity' where id='$id'");
